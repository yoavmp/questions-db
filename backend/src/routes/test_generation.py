...
def generate_test():
    ...
    try:
        ...
        selected_questions.sort(
            key=lambda item: get_category_order_index(item[1])
        )
        
        # Convert to dict format for response
        test_questions = []
        for i, (question, selected_category) in enumerate(selected_questions, 1):
            test_questions.append({
                ...
                # Category whose quota this question satisfies.
                # The frontend should send this value when replacing the question.
                'category': selected_category,

                # Preserve the database primary category if needed elsewhere.
...
def replace_question():
    ...
    try:
        ...
        replacement_data = {
            ...
            'primary_category': replacement_question.category,
